                    ...
                    <div class="form-group">
                        <form id="content-type-form">
                            <select name="type" id="content-type" class="form-control" required>
                                ...
                                <option value="file" {{ $selected_type === 'file' ? 'selected' : '' }}>File Content
                                </option>
                            </select>
                        </form>
                    </div>
                            ...
                            <div class="col">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-footer" style="background-color:lightsteelblue">
                                        <input type="hidden" class="file-mime-data"
                                            value="{{ Storage::mimeType($content->path) }}">
                                        <input type="hidden" class="file-data"
                                            value="data:{{ Storage::mimeType($content->path) }};base64,{{ base64_encode(Storage::get($content->path)) }}">
