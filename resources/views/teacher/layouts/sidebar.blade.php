 ...
 <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link {{ Route::currentRouteName() === 'teacher.content.index' ? 'active' : '' }}"  href="{{ route('teacher.content.index') }}">
                                    <i class="icon">
                             ...
                             <li class="nav-item">
                                <a class="nav-link {{ Route::currentRouteName() === 'teacher.group.list' ? 'active' : '' }}"  href="{{ route('teacher.group.list') }}">
                                    <i class="icon">
                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
