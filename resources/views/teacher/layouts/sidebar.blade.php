     ...
     <div class="sidebar-body pt-0 data-scrollbar">
         <div class="sidebar-list">
             ...
             <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                 ...
                 <li class="nav-item">
                     <a class="nav-link {{ Route::currentRouteName() === 'teacher.dashboard' ? 'active' : '' }}"
                         aria-current="page" href="{{ route('teacher.dashboard') }}">
                         <i class="icon">
                 ...
                 <li class="nav-item">
                     <a class="nav-link {{ Route::currentRouteName() === 'teacher.course.index' ? 'active' : '' }}"
                         href="{{ route('teacher.course.index') }}">
                         <i class="icon">
                             <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                 <path fill-rule="evenodd" clip-rule="evenodd"
                         ...
                         <span class="item-name">Courses</span>
                                  ...
                                  <li class="nav-item">
                     <a class="nav-link {{ Route::currentRouteName() === 'teacher.exam.index' ? 'active' : '' }}"
                         href="{{ route('teacher.exam.index') }}">
                         <i class="icon">
                             <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                 <path fill-rule="evenodd" clip-rule="evenodd"
                 ...
                 <li class="nav-item">
                     ...
                     <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                         <li class="nav-item">
                             <a class="nav-link {{ Route::currentRouteName() === 'teacher.content.index' ? 'active' : '' }}"
                                 href="{{ route('teacher.content.index') }}">
                                 <i class="icon">
                         ...
                         <li class="nav-item">
                             <a class="nav-link {{ Route::currentRouteName() === 'teacher.group.list' ? 'active' : '' }}"
                                 href="{{ route('teacher.group.list') }}">
                                 <i class="icon">
                                     <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10"
                                         viewBox="0 0 24 24" fill="currentColor">
                                         <g>
