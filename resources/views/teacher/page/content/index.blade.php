            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="form-group">
                        <a href="{{ route('teacher.course.content.create', $course_id) }}"
                            ...
                            <div class="col">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-footer" style="background-color:lightsteelblue">
                                        ...
                                        @endif
                                        @if ($content->type === 'file')
                                            <a href="{{ route('teacher.course.content.download', $content->id) }}"
                                                class="btn btn-primary btn-sm"><i class="bi bi-download"></i></a>
                                        @endif
                                        <input type="hidden" class="row-id"
                                            value="{{ route('teacher.course.content.destroy', $content->id) }}">
